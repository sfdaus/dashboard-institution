...
func main() {
	...
	institutionRepo := pgsqlRepository.NewPgsqlInstitutionRepository(dbInstance)
	...
	institutionUC := usecase.NewInstitutionUsecase(institutionRepo, redisRepo, ctxTimeout)
	...
	httpDelivery.NewInstitutionHandler(e, appMiddleware, institutionUC)
